...
class Database:
    ...
    def delete_account_immediately(user_id: str) -> bool:
        ...
        try:
            ...
            # Note: No subscription cleanup needed since we only use one-time payments
            ...
            # Note: No subscription data to delete since we only use one-time payments
    ...
    # Legacy Subscription Methods (to be removed after migration)
